...
func (*QueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3b449635ad5185e, []int{3}
}
...
func (*LabelRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3b449635ad5185e, []int{4}
}
...
func (*LabelResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3b449635ad5185e, []int{5}
}
...
func (*Stream) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3b449635ad5185e, []int{6}
}
...
func (*Entry) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3b449635ad5185e, []int{7}
}
...
func (*TailRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3b449635ad5185e, []int{8}
}
...
func (*TailResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3b449635ad5185e, []int{9}
}
...
func (*DroppedStream) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3b449635ad5185e, []int{10}
}
...
var fileDescriptor_a3b449635ad5185e = []byte{
	...
	,
}
...
func (m *PushRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Streams) > 0 {
		for _, msg := range m.Streams {
			dAtA[i] = 0xa
			i++
			i = encodeVarintLoki(dAtA, i, uint64(msg.Size()))
...
func (m *QueryRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Query) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintLoki(dAtA, i, uint64(len(m.Query)))
		i += copy(dAtA[i:], m.Query)
	}
	if m.Limit != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintLoki(dAtA, i, uint64(m.Limit))
	}
	dAtA[i] = 0x1a
	i++
	i = encodeVarintLoki(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.Start)))
	...
	dAtA[i] = 0x22
	i++
	i = encodeVarintLoki(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.End)))
	...
	if m.Direction != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintLoki(dAtA, i, uint64(m.Direction))
	}
	if len(m.Regex) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintLoki(dAtA, i, uint64(len(m.Regex)))
...
func (m *LabelRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Name) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintLoki(dAtA, i, uint64(len(m.Name)))
...
func (m *Entry) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xa
	i++
	i = encodeVarintLoki(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.Timestamp)))
...
func (m *TailRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DelayFor != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintLoki(dAtA, i, uint64(m.DelayFor))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *TailResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Stream != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintLoki(dAtA, i, uint64(m.Stream.Size()))
...
func (m *DroppedStream) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xa
	i++
	i = encodeVarintLoki(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.From)))
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintLoki(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.To)))
...
func (m *QueryRequest) Size() (n int) {
	...
	n += 1 + l + sovLoki(uint64(l))
	if m.Direction != 0 {
		n += 1 + sovLoki(uint64(m.Direction))
	}
	l = len(m.Regex)
	if l > 0 {
		n += 1 + l + sovLoki(uint64(l))
